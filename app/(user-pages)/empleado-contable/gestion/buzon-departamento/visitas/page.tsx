...
// Datos de ejemplo para visitas del departamento contable
const visitasData = [
  {
    id: 1,
    numeroSolicitud: "VIS-CON-001",
    tipoVisita: "Laboral",
    ...
    horaSolicitud: "14:30",
    observaciones: "Auditoría contable anual. Revisión de registros financieros y documentación.",
    personas: [
      {
        nombre: "Contador Juan Carlos Morales",
        dni: "25.123.456",
        email: "jmorales@auditoria.com.ar",
        telefono: "11-4567-8901",
      },
      {
        nombre: "Asistente María Elena Vega",
        dni: "28.987.654",
        email: "mvega@auditoria.com.ar",
...
export default function BuzonVisitasContablePage() {
