...
export default function DatosPersonalesEmpleadoGerente() {
  const [date, setDate] = useState<Date | undefined>(new Date(1975, 7, 22))
  ...
  const datosLaborales = {
    ...
    cargo: "GERENTE",
    superiorJerarquico: "Dr. Eduardo Fernández (Presidente)",
    fechaIngreso: "05/03/2010",
    antiguedad: "13 años, 3 meses",
  }
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input
                    value="laura.rodriguez@plp.gob.ar"
                    readOnly={!isEditing}
                    className={cn(
                      "bg-white",
                      !isEditing && "border-gray-200 focus-visible:ring-0 focus-visible:ring-offset-0",
