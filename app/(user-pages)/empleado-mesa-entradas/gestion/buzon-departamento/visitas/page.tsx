...
// Datos de ejemplo para visitas del departamento de mesa de entradas
const visitasData = [
  {
    id: 1,
    numeroSolicitud: "VIS-MES-001",
    tipoVisita: "Laboral",
    ...
    horaSolicitud: "14:30",
    observaciones: "Presentación de documentación para expediente administrativo. Requiere acceso a archivo.",
    personas: [
      {
        nombre: "Dr. Carlos Alberto Mendez",
        dni: "25.123.456",
        email: "cmendez@estudiojuridico.com.ar",
        telefono: "11-4567-8901",
      },
      {
        nombre: "Escribana María González",
        dni: "28.987.654",
        email: "mgonzalez@estudiojuridico.com.ar",
...
export default function BuzonVisitasMesaEntradasPage() {
