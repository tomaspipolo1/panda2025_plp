...
export default function MisVisitasEmpleadoCompras() {
  ...
  // Datos de ejemplo para las visitas con los tipos específicos para empleado-compras
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-2">
          ...
          <Button className="bg-black hover:bg-gray-800 flex items-center gap-2 w-15">
            <Link href="/empleado-compras/visitas/nueva-visita">
