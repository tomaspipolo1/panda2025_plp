...
import { Building, ClipboardList, Calendar, Clock, CreditCard, ShoppingCart, Gavel } from "lucide-react"
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-plp-dark">Panel de Compras</h1>
          <p className="text-gray-600 mt-2">Gestión integral de compras y proveedores del puerto</p>
        </div>
      </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            <div className="flex items-start space-x-3 p-3 bg-gray-50 rounded-lg">
              ...
              <div>
                <p className="text-sm font-medium">Apertura Licitación Grúas Portuarias</p>
                <p className="text-xs text-gray-600">Sala de Licitaciones - Edificio Administrativo</p>
                <p className="text-xs text-gray-500">18 Ene 2025 - 10:00</p>
              </div>
            </div>
            <div className="flex items-start space-x-3 p-3 bg-gray-50 rounded-lg">
              <div className="w-2 h-2 bg-green-500 rounded-full mt-2"></div>
              <div>
                <p className="text-sm font-medium">Comité de Compras</p>
            ...
            <div className="flex items-start space-x-3 p-3 bg-gray-50 rounded-lg">
              ...
              <div>
                <p className="text-sm font-medium">Inspección Proveedor TecnoPort</p>
                <p className="text-xs text-gray-600">Instalaciones del Proveedor</p>
            ...
            <div className="flex items-start space-x-3 p-3 bg-gray-50 rounded-lg">
              ...
              <div>
                <p className="text-sm font-medium">Recepción Equipos Logísticos</p>
                <p className="text-xs text-gray-600">Almacén Central - Puerto</p>
                <p className="text-xs text-gray-500">01 Feb 2025 - 08:00</p>
              </div>
            </div>
          </CardContent>
        </Card>
            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-3 p-3 bg-gray-50 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-600">OC-2025-001 - Aceros del Sur S.A.</p>
              ...
              <div className="flex items-start space-x-3 p-3 bg-gray-50 rounded-lg">
                <div className="w-2 h-2 bg-blue-500 rounded-full mt-2"></div>
                <div>
                  <p className="text-sm font-medium">Nuevo proveedor registrado</p>
                  <p className="text-xs text-gray-600">Transportes Marítimos del Plata</p>
              ...
              <div className="flex items-start space-x-3 p-3 bg-gray-50 rounded-lg">
                <div className="w-2 h-2 bg-purple-500 rounded-full mt-2"></div>
                <div>
                  <p className="text-sm font-medium">Licitación publicada</p>
                  <p className="text-xs text-gray-600">LIC-2025-003 - Equipos de Seguridad</p>
              ...
              <div className="flex items-start space-x-3 p-3 bg-gray-50 rounded-lg">
                <div className="w-2 h-2 bg-orange-500 rounded-full mt-2"></div>
                <div>
                  <p className="text-sm font-medium">Solicitud de compra procesada</p>
                  <p className="text-xs text-gray-600">SOL-2025-045 - Departamento de Operaciones</p>
