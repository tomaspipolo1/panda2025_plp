...
export default function NuevaVisitaPage() {
  ...
  const tiposVisita = ["Laboral", "Guiada", "Evento", "Transporte Cargas", "Acceso a Obra", "Acceso a Muelle"]
  ...
  const tiposCarga = ["Granel", "Liquida", "Gases", "Contenedores", "Paquetes", "Otro"]

  return (
    <div className="p-6 max-w-7xl mx-auto">
      <div className="flex items-center mb-6">
        <Link
          href="/empleado-seguridad/visitas/pendientes"
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="flex justify-end space-x-4">
          <Button variant="outline" type="button" asChild>
            <Link href="/empleado-seguridad/visitas/pendientes">Cancelar</Link>
          </Button>
