...
export default function DatosPersonalesPage() {
  ...
  // Dentro del componente DatosPersonalesPage, agregar estos datos de ejemplo para la información laboral
  const datosLaborales = {
    gerencia: "Gerencia de Operaciones",
    departamento: "SEGURIDAD INTEGRAL",
    cargo: "COORDINADOR",
    superiorJerarquico: "Miguel Torres (Jefe de Departamento)",
    fechaIngreso: "15/06/2012",
    antiguedad: "11 años",
    legajo: "LEG-9210",
  }
