...
export default function MisVisitasEmpleadoRRHH() {
  ...
  // Datos de ejemplo para las visitas con los tipos específicos para empleado-rrhh
  const visitas: Visita[] = [
    {
      ...
      vehiculos: 1,
      estado: "Pendiente",
      solicitante: "Departamento de RRHH",
      descripcion: "Inspección de seguridad laboral",
      personasDetalle: [
        {
          id: "1",
          nombre: "Juan Pérez",
    ...
    },
    {
      id: "2",
      fecha: "15/12/2023",
      tipo: "Visita a proveedor",
      sitio: "Consultora de RRHH S.A.",
      personas: 4,
      vehiculos: 2,
      estado: "Aprobada",
      solicitante: "Juan Pérez (RRHH)",
      descripcion: "Evaluación de servicios de capacitación",
      personasDetalle: [],
      vehiculosDetalle: [],
    },
    {
      ...
      vehiculos: 0,
      estado: "Completada",
      solicitante: "María González (RRHH)",
      descripcion: "Revisión de políticas de personal",
      personasDetalle: [],
      vehiculosDetalle: [],
    },
    {
      ...
      vehiculos: 1,
      estado: "Cancelada",
      solicitante: "Carlos Rodríguez (Seguridad)",
      descripcion: "Verificación de condiciones laborales",
      personasDetalle: [],
      vehiculosDetalle: [],
    },
    {
      ...
      fecha: "20/01/2024",
      tipo: "Visita a proveedor",
      sitio: "Centro de Capacitación S.A.",
      personas: 3,
      vehiculos: 1,
      estado: "Pendiente",
      solicitante: "Ana Martínez (RRHH)",
      descripcion: "Evaluación de programas de formación",
      personasDetalle: [],
      vehiculosDetalle: [],
    },
    {
      ...
      fecha: "25/01/2024",
      tipo: "Reunión",
      sitio: "Oficina de RRHH",
      personas: 5,
      vehiculos: 2,
      estado: "Pendiente",
      solicitante: "Roberto Sánchez (Gerencia)",
      descripcion: "Revisión de estructura organizacional",
      personasDetalle: [],
      vehiculosDetalle: [],
    },
  ]
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-2">
          ...
          <Button className="bg-black hover:bg-gray-800 flex items-center gap-2 w-15">
            <Link href="/empleado-rrhh/visitas/nueva-visita">
            ...
            <div className="relative">
              <Select value={tipoVisita} onValueChange={setTipoVisita} onOpenChange={setShowTipoOptions}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="proveedor">Visita a proveedor</SelectItem>
              ...
              {showTipoOptions && (
                <div className="absolute top-full left-0 w-full bg-white border border-gray-200 rounded-md shadow-md z-10 mt-1">
                  ...
                  <div className="p-2 hover:bg-gray-100 cursor-pointer flex items-center">
                    <input
                      type="checkbox"
                      checked={tipoVisita === "inspeccion"}
                      onChange={() => setTipoVisita("inspeccion")}
                      className="mr-2"
                    />
                  ...
                  <div className="p-2 hover:bg-gray-100 cursor-pointer flex items-center">
                    <input
                      type="checkbox"
                      checked={tipoVisita === "proveedor"}
                      onChange={() => setTipoVisita("proveedor")}
                      className="mr-2"
                    />
                    <span>Visita a proveedor</span>
                  </div>
                  <div className="p-2 hover:bg-gray-100 cursor-pointer flex items-center">
                    <input
                      type="checkbox"
                      checked={tipoVisita === "reunion"}
                      onChange={() => setTipoVisita("reunion")}
                      className="mr-2"
                    />
                    <span>Reunión</span>
                  </div>
