...
// Datos de ejemplo para visitas del departamento de RRHH
const visitasData = [
  {
    id: 1,
    numeroSolicitud: "VIS-RRH-001",
    tipoVisita: "Laboral",
    ...
    horaSolicitud: "14:30",
    observaciones: "Entrevistas laborales para nuevos puestos en el área operativa. Proceso de selección.",
    personas: [
      {
        nombre: "Lic. Patricia Morales",
        dni: "28.987.654",
        email: "pmorales@consultorarhh.com.ar",
        telefono: "11-5555-1234",
      },
      {
        nombre: "Psic. Roberto Fernández",
        dni: "32.456.789",
        email: "rfernandez@consultorarhh.com.ar",
...
export default function BuzonVisitasRRHHPage() {
