...
interface DetalleMovimientoClienteProps {
  isOpen: boolean
  onClose: () => void
  movimiento: {
    id: string
...
export function DetalleMovimientoModalCliente({ isOpen, onClose, movimiento }: DetalleMovimientoClienteProps) {
        ...
        <div className="mt-4">
          <div className="grid grid-cols-2 gap-4 mb-4">
            ...
            <div>
              ...
              <p className="font-medium">{movimiento.detalles?.entidad || "Puerto La Plata"}</p>
            </div>
