...
import { ChevronDown, ChevronUp, FileText, CreditCard, ArrowDownLeft, ArrowUpRight, Download } from "lucide-react"
...
export function TablaMovimientos({ movimientos, onVerDetalle, onDescargarPDF }: TablaMovimientosProps) {
