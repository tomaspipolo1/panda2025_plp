...
interface FormularioNuevaVisitaEmpleadoMesaEntradasProps {
  onSubmit: (data: any) => void
  onCancel: () => void
}

export function FormularioNuevaVisitaEmpleadoMesaEntradas({
  onSubmit,
  onCancel,
}: FormularioNuevaVisitaEmpleadoMesaEntradasProps) {
