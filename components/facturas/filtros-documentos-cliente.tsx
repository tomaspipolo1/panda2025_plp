...
interface FiltrosDocumentosClienteProps {
  tipo: "facturas" | "notasCredito" | "notasDebito"
  onFilter: (filters: any) => void
}

export function FiltrosDocumentosCliente({ tipo, onFilter }: FiltrosDocumentosClienteProps) {
  ...
  return (
    <div className="mb-6">
      ...
      <div className="flex justify-end mt-6 space-x-2">
        <Button variant="outline" onClick={handleLimpiar} className="bg-white">
          Limpiar
        </Button>
